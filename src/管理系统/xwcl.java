...
class BackgroundPanel0 extends JPanel
{
    Image im;
    public BackgroundPanel0(Image im)
    {
        this.im=im;
...
public class xwcl {
    ...
    private static BackgroundPanel0 contentPane;
    static int count=0;



    public static void referRecord(final JFrame choice){
        contentPane=new BackgroundPanel0((new ImageIcon("D:\\Java test\\mysql test\\src\\管理系统\\7397631DF70FB12718A8853EEAB60A5D.jpg")).getImage());
        contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
        contentPane.setLayout(null);
        contentPane.setSize( 1020, 550);
        final JFrame referStaff=new JFrame("行文处理");
        ...
        JLabel RECEIVER=new JLabel("XW_RECEIVER",JLabel.CENTER);
        JLabel CONTEXT=new JLabel("XW_CONTEXT",JLabel.CENTER);
        JLabel DATE=new JLabel("XW_DATE",JLabel.CENTER);
        JLabel REMARK=new JLabel("XW_REMARK",JLabel.CENTER);
        ...
        final JTextField XW_RECEIVER=new JTextField(10);
        final JTextField XW_CONTEXT=new JTextField(10);
        final JTextField XW_DATE=new JTextField(10);
        final JTextField XW_REMARK=new JTextField(10);
        ...
        titleVector.add("XW_RECEIVER");
        titleVector.add("XW_CONTEXT");
        titleVector.add("XW_DATE");
        titleVector.add("XW_REMARK");
        ...
        StaffJTable.addMouseListener(new MouseAdapter()
        {
            public void mouseClicked(MouseEvent e)
            {
                ...
                XW_RECEIVER.setText((String) v.get(3));
                XW_CONTEXT.setText((String) v.get(4));
                XW_DATE.setText((String) v.get(5));
                XW_REMARK.setText((String) v.get(6));
        ...
        division4.add(RECEIVER);
        division4.add(XW_RECEIVER);
        ...
        division5.add(REMARK);
        division5.add(XW_REMARK);
        ...
        insert.addMouseListener(new MouseAdapter(){
            public void mouseClicked(MouseEvent e){
                if(!XW_ID.getText().isEmpty()){
                    ...
                    String pRECEIVER = XW_RECEIVER.getText().trim();
                    String pCONTEXT = XW_CONTEXT.getText().trim();
                    String pDATE= XW_DATE.getText().trim();
                    String pREMARK = XW_REMARK.getText().trim();


                    addProcess(pID,pNAME,pAUTHER,pRECEIVER,pCONTEXT,pDATE,pREMARK);
                    queryAllProcess(staffVector,StaffJTable);
                }
        ...
        update.addMouseListener(new MouseAdapter(){
            public void mouseClicked(MouseEvent e){
                if(!XW_NAME.getText().isEmpty()){
                    ...
                    UpdateProcess(pID,pNAME,pAUTHER,pRECEIVER,pCONTEXT,pDATE,pREMARK);
                    queryAllProcess(staffVector,StaffJTable);
    ...
    public static void queryProcess(String sQueryField,Vector staffVector,JTable StaffJTable){
        try{
            String sql=null;
                ...
                sql = "select XW_ID,XW_NAME,XW_AUTHER,XW_RECEIVER,XW_CONTEXT,XW_DATE,XW_REMARK from xwcl where ";
                sql = sql + "XW_ID";
                sql = sql + " like ";
                sql = sql + "'" +'%' +sQueryField +'%' +"';";
            ...
            while(DbProcess.rs.next()){
                ...
                v.add(DbProcess.rs.getString("XW_RECEIVER"));
                v.add(DbProcess.rs.getString("XW_CONTEXT"));
                v.add(DbProcess.rs.getString("XW_DATE"));
                v.add(DbProcess.rs.getString("XW_REMARK"));
    ...
    public static void  UpdateProcess( String pID, String pNAME, String pAUTHER, String pRECEIVER,String pCONTEXT, String pDATE, String pREMARK)
    {
        //int QNo=yuangongchaxun.refercount();
        // String qNo=String.valueOf(QNo+1);
        String sql = "update xwcl set XW_NAME = '";
        sql = sql + pNAME + "', XW_AUTHER = '";
        sql = sql + pAUTHER + "', XW_RECEIVER = '";
        sql = sql + pRECEIVER + "', XW_CONTEXT = '";
        sql = sql + pCONTEXT + "', XW_DATE = '";
        sql = sql + pDATE + "', XW_REMARK = '";
        sql = sql + pREMARK + "'";
    ...
    public static void  addProcess(String pID, String pNAME, String pAUTHER, String pRECEIVER,String pCONTEXT, String pDATE, String pREMARK)
    {
        String sql="insert into xwcl values('";
        sql=sql+pID+"','";
        sql=sql+pNAME+"','";
        sql=sql+pAUTHER+"','";
        sql=sql+pRECEIVER+"','";
